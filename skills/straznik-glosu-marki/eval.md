...
Przejdź po każdej walidacji, zanim uznasz raport za gotowy. Osiem checków, każdy pass albo fail. Jeden fail = walidator uruchamiany ponownie z informacją, który check padł.
...
2. **Cytaty dosłowne.** Wybrane 3 cytaty sprawdź w ocenianym tekście znak w znak. Parafraza = fail.
